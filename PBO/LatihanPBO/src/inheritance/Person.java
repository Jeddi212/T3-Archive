...
public abstract class Person implements CobaInterface {
    ...
    void hitungMethodTidakDiOverride() { System.out.println("INI METHOD DI PARENT YANG TIDAK DIOVERRIDE"); }
    ...
    void hitungParentMethod() { System.out.println("INI OVERRIDE METHOD MILIK PARENT"); }
    ...
    public void printMethodCobaInterface1() {
        // do something here
        System.out.println("Override method dari interface1 di person");
    }
}
